...
public class DefaultCrawler implements ICrawlerfj {
        ...
        try{
            ...
            for(DefaultConfigEntity.ElementEntity elementEntity : configEntity.getElementEntityList()){
                ...
                switch (elementEntity.getHandleAction()){
                    ...
                    case download:doDownload(elements,responseEntity);break;
                    default:break;
                }
            }
        }catch(Exception e){
    ...
    private void doDownload(Elements elements,ResponseEntity resEntity){
        //TODO
        String folderPath = "C:\\Users\\Administrator\\Desktop\\img";
