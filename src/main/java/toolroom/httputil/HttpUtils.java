...
public class HttpUtils {
    ...
    public static ResponseEntity doGetByBrowser(RequestEntity requestEntity) throws Exception {
        if(driverDispatchPool == null){
        ...
        String pageSource =  driverDispatchPool.ExecuteWithFreeInstance((param1,params) ->{
            WebDriver driver = (WebDriver)param1;
            RequestEntity requestEntity1 = (RequestEntity)params[0];
            driver.get(requestEntity1.getRequestURL());
        ...
        responseEntity.setDomain(Regex.getDomain(requestEntity.getRequestURL()));
        //获取协议
        responseEntity.setProtocol(Regex.getProtocol(requestEntity.getRequestURL()));
        Map<String,String> responseHeaderMap = new HashMap<>();
//        headers = response.getAllHeaders();
//        for(Header header : headers){
//            responseHeaderMap.put(header.getName(),header.getValue());
//        }
    ...
    public static ResponseEntity doGetByBrowser_Htmlunit(RequestEntity requestEntity) throws IOException {
        WebClient webClient;
